...
from .models import AdPlacement, AdCampaign, AdBanner, AdImpression, AdClick, AdZone


@admin.register(AdPlacement)
class AdPlacementAdmin(admin.ModelAdmin):
    list_display = ('name', 'placement_type', 'width', 'height', 'is_active', 'created_at')
...
class AdCampaignAdmin(admin.ModelAdmin):
    list_display = ('name', 'advertiser', 'status', 'budget', 'start_date', 'end_date', 'is_active', 'created_at')
...
class AdBannerAdmin(admin.ModelAdmin):
    list_display = ('name', 'campaign', 'placement', 'banner_type', 'is_active', 'priority', 'impressions_count', 'clicks_count', 'ctr_display', 'created_at')
    list_filter = ('banner_type', 'is_active', 'campaign', 'placement', 'created_at')
    search_fields = ('name', 'alt_text', 'target_url')
    readonly_fields = ('impressions_count', 'clicks_count', 'ctr_display', 'created_at', 'updated_at')
    ...
    fieldsets = (
        ...
        ('Настройки отображения', {
            'fields': ('is_active', 'priority', 'weight')
        }),
        ('Статистика', {
...
class AdImpressionAdmin(admin.ModelAdmin):
    ...
    def get_queryset(self, request):
        return super().get_queryset(request).select_related('banner', 'banner__campaign', 'banner__placement')
