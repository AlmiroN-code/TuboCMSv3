...
urlpatterns = [
    ...
    path('htmx/form/<slug:video_slug>/<int:parent_id>/', htmx_views.comment_form, name='htmx_reply_form'),
    path('htmx/create/<slug:video_slug>/', htmx_views.comment_create, name='htmx_create'),
    path('htmx/create/<slug:video_slug>/<int:parent_id>/', htmx_views.comment_create, name='htmx_reply_create'),
    path('htmx/edit-form/<int:comment_id>/', htmx_views.comment_edit_form, name='htmx_edit_form'),
    path('htmx/replies/<int:comment_id>/', htmx_views.comment_replies, name='htmx_replies'),
    path('htmx/report-form/<int:comment_id>/', htmx_views.comment_report_form, name='htmx_report_form'),
