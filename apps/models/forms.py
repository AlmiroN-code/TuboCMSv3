...
class ModelForm(forms.ModelForm):
    ...
    class Meta:
        model = Model
        fields = [
            'user', 'display_name', 'bio', 'avatar', 'cover_photo',
            ...
            'height', 'weight', 'is_verified', 'is_active', 'is_premium'
        ]
        widgets = {
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['user'].queryset = User.objects.exclude(id__in=existing_model_users).order_by('username')
        ...
        if self.instance and self.instance.pk:
            ...
            self.fields['user'].help_text = "Пользователь не может быть изменен для существующей модели"
...
class ModelVideoForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['model'].queryset = Model.objects.filter(is_active=True).order_by('display_name')
