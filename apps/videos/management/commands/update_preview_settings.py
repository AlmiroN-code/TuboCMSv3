...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(f'  Poster: {settings.poster_width}x{settings.poster_height}, quality: {settings.poster_quality}')
        self.stdout.write(f'  Preview: {settings.preview_width}x{settings.preview_height}, duration: {settings.preview_duration}s, quality: {settings.preview_quality}')
